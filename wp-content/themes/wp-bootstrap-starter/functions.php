...
function wp_bootstrap_starter_scripts() {
    ...
    // wp_register_style( 'slick-cdn', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.css' );
    // wp_enqueue_style('slick-cdn');
    wp_enqueue_style( 'slick-cdn', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.css' );
    wp_enqueue_style( 'slick-theme-cdn', 'http://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick-theme.css' );
    ...
    wp_register_script( 'slickjs-cdn', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js', null, null, true );
    wp_enqueue_script('slickjs-cdn');
